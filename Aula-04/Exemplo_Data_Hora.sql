...
values ("Fernando", "1994-07-08", "23:59:00", "joao@teste.com", CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()); -- Data e hora passadas como de fossem uma String-Função Current que pega no sistema exatamente os dados 

insert into tb_funcionarios (nome, data_nasc, hora_nasc, email, data_criacao, data_atualizacao) 
values ("Maiury", "1995-08-03", "13:59:00", "maria@teste.com", CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
DATE_FORMAT(data_nasc, "%d/%m/%Y") as Data_de_Nascimento,  -- Data formatada para o formmato PT-Brasil
TIME_FORMAT(hora_nasc, "%H:%i:%s") as Horário_do_Nascimento -- Hora formatada para o formmato PT-Brasil
